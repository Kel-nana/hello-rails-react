...
**Hello Rails React** Implements connection: Rails back-end to React front-end, displaying random greeting message.
...
```
  git clone git@github.com:Kel-nana/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/Kel-nana/hello-rails-react/issues).
...
This project is [MIT](https://github.com/Kel-nana/hello-rails-react/blob/dev/LICENSE) licensed.
